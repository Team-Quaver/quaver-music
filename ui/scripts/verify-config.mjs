...
eq("schema 默认值表条数", Object.keys(defaults()).length, 15);
...
eq("侧栏宽度默认 220", defaults()["Window.SidebarWidth"], "220");
eq("非法侧栏宽度被拒绝", writeValues({ "Window.SidebarWidth": "100" }), []);
eq("合法侧栏宽度写入", writeValues({ "Window.SidebarWidth": "300" }), ["Window.SidebarWidth"]);
